...
var IDE_status_message = "Use this environment to learn and apply TEA.";
...
const WEB_IDE_DOCS_COMPLETE = "---[ TEA WEB IDE DOCS ]---\n\n" +
    ...
    "2. MENU: The menu contains several links to either documentation about TEA, or buttons/links that trigger certain functionalities such as showing this documentation, resetting the WEB IDE input spaces as well as changing the active THEME among others." + "\n\n"+
    ...
    "7. TEA Code: Use this space to manually compose or preview a TEA Program's source code, and which code is the main program to be executed when the IDE is compelled to RUN, VALIDATE, SANITIZE or MINIFY later on." + "\n\n"+
    ...
    "9. SANITIZE or MINIFY: Click the button 'SANITIZE' to Reformat the provided TEA Code into the simplest, clean and comment-free program code. No actual execution of the program occurs, and the results of the sanitization are automatically set as the TEA Output so that it becomes easy to copy and paste that as either input or code if desired. 'MINIFY' on the other hand works like SANITIZE, but produces a most compact version of the clean TEA Program." + "\n\n"+
...
U.click("trig_reset_ide", function() {
    ...
    //toggle_light_theme(); no, leave user-selected theme out of this..
