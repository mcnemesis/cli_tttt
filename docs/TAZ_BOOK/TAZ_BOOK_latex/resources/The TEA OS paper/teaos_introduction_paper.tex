...
It should be worth noting that final aspect... ``that fits inside a string", because it shall without doubt explain why and how it is that the reference implementation of the TEA operating system is currently being shipped alongside other \textit{standard} TEA programs\cite{Lutalo2026TEA} that essentially are loadable into the TEA WEB IDE via a mere JSON payload! 
