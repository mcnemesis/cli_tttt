...
\fancyhead[L]{TEA TAZ | TEA Operating System v1.1.0 complete source code}
...
{
  \begin{lstlisting}[style=tea,caption=TEA Program: TOS v1.1.0 Complete Source-Code (SANITIZED form), label=LST3,breaklines=true,numbers=left]
