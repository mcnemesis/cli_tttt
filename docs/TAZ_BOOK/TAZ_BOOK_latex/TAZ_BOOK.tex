...
The basic application is going to be called \textbf{E-MAILER}, and the essential, fully-tested source-code for version 1.3 of our next standard TEA application is as such:

\vspace{2em}

{
 \Large
  \begin{tcolorbox}[teaterminalstyle, title=TEA Program: E-MAILER v1.3, breakable]
  \begin{lstlisting}[language=TEA,breaklines=true,numbers=left]
#/usr/bin/env tttt -fc
#######################################
v:vABOUT:{@@@@@@| E-MAILER v1.3 |@@@@@@
...
@@@@@@[ Sent using TEA E-Mailer ]@@@@@@}|v:vMailBody
...
# As a feature, SENDER is included in CC
# since we can't send as arbitrary
# addresses (standard e-email security that is... )
...
j:lRESET
   \end{lstlisting}
  \end{tcolorbox}
  \caption{TEA APPLICATION: E-MAILER v1.3 --- a basic E-Mail sending client in TEA}
  \label{FIGWAPP1}
}
...
\vspace{2em}
 \begin{tcbverbatim}[title=Sample OUTPUT from EMAILER v1.3]
