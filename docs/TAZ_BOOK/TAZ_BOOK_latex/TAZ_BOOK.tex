...
The essential idea here, and which is somewhat related to estimating or judging a system's --- especially a programming language such as TEA, C++, Python or Ruby --- maturity, is that, just like most such technology platforms must demonstrate their usability and practicability via a simple application such as the famous ``Hello World"\cite{lutalo2020dnap}, a program that merely show how to print a simple string and nothing else, for mature and advanced systems, the simple application that can send an email is the ultimate demonstration of the platform or system's power and readiness for real-world use.
