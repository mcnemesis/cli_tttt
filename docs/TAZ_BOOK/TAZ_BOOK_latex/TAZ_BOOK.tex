...
\subsection{EXAMPLE 1: \textbf{COMPUTER ARCHITECTURE:} TEA Operating System (TOS)}
\label{SECEXAMP1Z}
...
\hspace*{\fill} --- \textbf{Operating Systems: Three Easy Pieces}\cite{arpacidusseau2018ostep}
\end{quotation}
...
\end{quote}}
\hspace*{\fill} --- \textbf{DNAP: Dynamic Nuchwezi Architecture Platform-A New Software Extension and Construction Technology}\cite{lutalo2023dnapsoe}
\end{quotation}
...
\subsubsection{The TOS Specification}
...
Lutalo, Joseph Willrich (2024). \textbf{TEA TAZ: Transforming Executable Alphabet A: to Z: COMMAND SPACE SPECIFICATION.} Figshare. Book. \url{https://www.academia.edu/122871672/}
