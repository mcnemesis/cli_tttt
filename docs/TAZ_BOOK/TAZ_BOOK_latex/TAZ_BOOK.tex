...
\makecell[l]{v*:vNAME\\v*:vNAME:vVALUE} & Store value vVALUE in vault vNAME overriding where necessary. Returns AI\\
...
\begin{figure}[H]
  ...
  \begin{lstlisting}
PLATFORM:WEB;VERSION:1.4.4;DATE:Tuesday, 07 April 2026;TIME:16:23:39
  \end{lstlisting}
  \end{tcolorbox}
