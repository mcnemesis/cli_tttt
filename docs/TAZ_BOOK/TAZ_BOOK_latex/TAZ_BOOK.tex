...
\subsection{EXAMPLE 1: The RANKING UTILITY (RU)}
\label{SECEXAMP1O}
...
\subsection{EXAMPLE 1: A Random VOWEL HYMN Generator}
\label{SECEXAMP1P}
...
\subsection{EXAMPLE 1: PERSONALITY CALCULATOR  }
\label{SECEXAMP1Q}
...
\subsection{EXAMPLE 1: SMS and TEXT Minifier Program }
\label{SECEXAMP1R}
...
\vspace{2em}
 ...
 \begin{figure}[H]
 \Large
  \begin{tcolorbox}[teaterminalstyle, title=TEA Program:  SMS-TEXT MINIFIER v3]
    \begin{lstlisting}[language=TEA,breaklines=true,numbers=left]
#====================================
...
this is d oficial web integratd development environment 4 d trans4min executable alphabt computer programin language.
 ...
 https://gist.githubusercontent.com/mcnemesis/648d348ce61eb5765421e8fb434c1b19/raw/sms_text_minifier.tea
...
\subsection{EXAMPLE 2: BASIC MATHEMATICS CALCULATOR}
\label{SECEXAMP2R}
...
\subsection{EXAMPLE 3: INVISIBLE TEXT DECODER }
\label{SECEXAMP3R}
