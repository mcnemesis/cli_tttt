...
{
 \Large
  \begin{tcolorbox}[teaterminalstyle, title=TEA Program:  Advanced Mathematics Computer v3, breakable]
  \begin{lstlisting}[language=TEA,breaklines=true,numbers=left]
v:vDESCRIPTION:{
#####################
# ADVANCED MATHEMATICS COMPUTER: AMC v3
#####################
...
y:vREPORT # show last report and quit
   \end{lstlisting}
  \end{tcolorbox}
  \caption{TEA APPLICATION: Advanced Mathematics Computer v3}
  \label{FIGR3}
}
...
\vspace{2em}
     ...
     \begin{tcbverbatim}[title=Sample OUTPUT 1 from AMC v3]
You entered:
##########################
3.1415*(101)**2
##########################
...
\vspace{2em}
     ...
     \begin{tcbverbatim}[title=Sample OUTPUT 2 from AMC v3]
You entered:
##########################
0.5*(1 + 5**(1/2))
##########################
...
\vspace{2em}
     ...
     \begin{tcbverbatim}[title=Sample OUTPUT 3 from AMC v3]
You entered:
##########################
(5-2)*(5+3)
##########################
...
\vspace{1em}
     ...
     \begin{tcbverbatim}[title=Sample OUTPUT 4 from AMC v3]
You entered:
##########################
(5-2)*5+3
##########################
...
\vspace{1em}
     ...
     \begin{tcbverbatim}[title=Sample OUTPUT 5 from AMC v3]
You entered:
##########################
5-2*5+3
##########################
...
\vspace{2em}
     ...
     \begin{tcbverbatim}[title=Sample OUTPUT 6 from AMC v3]
You entered:
##########################
5==(5e-1 * 100/10.0)
##########################
