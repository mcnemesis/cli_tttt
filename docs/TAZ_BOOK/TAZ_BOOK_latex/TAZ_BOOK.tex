...
\subsection{EXAMPLE 1: STATISTICAL ANALYSIS: The RANKING UTILITY (RU)}
\label{SECEXAMP1O}
...
\subsection{EXAMPLE 1: MUSIC \& POETRY: A Random VOWEL HYMN Generator}
\label{SECEXAMP1P}
...
\subsection{EXAMPLE 1: PSYCHOLOGY \& ASTROLOGY: PERSONALITY CALCULATOR  }
\label{SECEXAMP1Q}
...
\subsection{EXAMPLE 1: HUMAN SUPPORT: SMS and TEXT Minifier Program }
\label{SECEXAMP1R}
...
\subsection{EXAMPLE 2: MATHEMATICS: ADVANCED MATHEMATICS COMPUTER}
\label{SECEXAMP2R}
...
\subsection{EXAMPLE 3: CRYPTOGRAPHY: INVISIBLE TEXT DECODER }
\label{SECEXAMP3R}
...
\subsection{EXAMPLE 1: CHILD EDUCATION: The SIR GAME}
\label{SECEXAMP1S}
...
\subsection{EXAMPLE 1: COMPUTATIONAL ART: Abstract Text-Art Generator}
\label{SECEXAMP1T}
