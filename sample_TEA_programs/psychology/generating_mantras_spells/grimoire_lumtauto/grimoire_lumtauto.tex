...
\begin{table}[H]
 ...
 \hline
	...
	\hline
	\textbf{ADONAI} & AIAAANAOAVAAA & A Deity\\
	\hline
	\textbf{EHIEH} & AHAEAIAHAEA & A Deity\\
	\hline
	\textbf{AGLA} & AAALASUAAA & A Deity\\
	\hline
	\textbf{EL} & ALAEA & A Deity\\
	\hline
	\textbf{YAHWEH} & AHAEAWAHAAAYA & A popular Christianized Deity\\
	\hline
	\textbf{JESUS} & ASAUASAEAJA & The God-Man of Nazareth\\
	\hline
	\textbf{YEHESHUA} & AAAUAHASAEAHAEAYA & Another form of ``JESUS"\\
	\hline
	\textbf{ALLAH} & AHAAALALAAA & Deity in Islam\\
	\hline
	\textbf{MAHOMET} & ATAEAMAOAHAAAMA & Deity popular with Templars\\
	\hline
	\textbf{MAMMON} & ANAOAMAMAAAMA & An Arch-Daemon associated with Wealth\\
	\hline
	\textbf{ASTAROTH} & ATAHAOARAAATASAAA & Demonised Deity associated with Astarte\\
	\hline
	\textbf{IAO} & AOAAAIA & Greek form of ``YHVH"\\
	\hline
	\textbf{RA} & AAARA & Ancient Deity in Khem\\
	\hline
	\textbf{AMUN RA} & AAARA ANAUAMAAA & Another form of RA\\
	\hline
	\textbf{KA} & AAAKA & The soul/spirit (Egyptian)\\
	\hline
	\textbf{TETU} & AUATAEATA & \makecell[l]{Deity of Magick (Egyptian)\\ also ``THOTH", ``TAHUTI"}\\
	\hline
	...
	\hline
	\textbf{MAHE} & AEAHAAAMA & A Deity (Hindu) also ``SHIVA"\\
	\hline
	\textbf{BANGA} & AAASUANAAABA &\makecell[l]{Deity of Space (Ganda)\\associated with aliens}\\
	\hline
	\textbf{KIBUKA} & AAAKAUABAIAKA &\makecell[l]{A Deity (Ganda)\\associated with thunder and air-travel}\\
	\hline
	\textbf{KINTU} & AUATAAANAIAKA &\makecell[l]{A Deity (Ganda)\\associated with matter\\or alchemical element ``Earth"}\\
	\hline
	\textbf{AHA} & AAAHAAA & \makecell[l]{A Deity (Cwezi)\\of Divine Providence}\\
	\hline
	\textbf{WEIRA} & AAARAIAEAWA & \makecell[l]{A Deity (Cwezi)\\Mysterious ``First Cause"}\\
	\hline
	\textbf{IRAKA} & AAAKAAARAIA & \makecell[l]{A Deity (Cwezi)\\associated with communication}\\
	\hline
	\textbf{MANI} & AIANAAAMA & \makecell[l]{A Deity (Cwezi)\\Mysterious ``Almighty"}\\
	\hline
