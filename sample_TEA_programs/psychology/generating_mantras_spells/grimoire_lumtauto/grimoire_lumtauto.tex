...
First, before we dive into exploring our third magical language system, let us first jump into a time machine, and travel back to the most ancient days... let us first trace our steps back to when writing and use of written language was still a thing exclusively only for high priests and the most dignified occultists in the land... back in [and before!] the days of \textbf{Hieroglyphics} and \textbf{the earliest forms of writing and written expressions}!
