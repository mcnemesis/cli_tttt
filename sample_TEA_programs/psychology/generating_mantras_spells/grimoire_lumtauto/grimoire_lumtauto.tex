...
\textbf{\hyperref[FIGLUMTAUTOTEACODE]{Figure \ref{FIGLUMTAUTOTEACODE}}} is the \textbf{source-code} of the non-interactive TEA program implementing this algorithm, and which, when actually cleaned of comments, would be the program depicted in  \textbf{\hyperref[FIGLUMTAUTOTEACODE_CLEAN]{Figure \ref{FIGLUMTAUTOTEACODE_CLEAN}}}. However, and in case one wishes to look at the code, modify or run \textbf{an interactive version} of it like on the Linux, Unix, Windows or MAC OS command-line or on the WEB, the most recent version should be what you might find or run directly and live via:
...
$\land \quad \tilde{A}(\Theta^n \rightarrow \Omega^k) > 1 \qed$
\end{trans}
...
\subsection{FOUR Examples of Applying MYRRH}
...
\begin{table}[H]
  ...
  %\LARGE
	\begin{tabular}[t]{|l|l|l|}
		\textbf{NAME} & \textbf{MYRRH'ed VERSION} & \textbf{RELEVANCE}\\
	\hline
 \hline
 	\textbf{RA} & AAARA & Ancient Deity in Khem\\
	\hline
	\textbf{AMUN RA} & ARA ANAUAMAAA & Another form of RA\\
	\hline
	\textbf{KA} & AAAKA & The soul/spirit (Egyptian)\\
	\hline
	\textbf{TETU} & AUATAEATA & \makecell[l]{Deity of Magick and Writing (Egyptian)\\ also ``THOTH", ``TAHUTI",\\ ``HERMES" (Greek)}\\
	
	\hline
	\hline
	\textbf{YHVH} & AHAVAHAYA & The Tetragrammaton/God of Israel\\
	\hline
	\textbf{ADONAI} & AIAAANAOAVAAA & A Deity (Kabalah)\\
	\hline
	\textbf{EHIEH} & AHAEAIAHAEA & A Deity (Kabalah)\\
	\hline
	\textbf{AGLA} & AAALASUAAA & A Deity (Kabalah)\\
	\hline
	\textbf{EL} & ALAEA & A Deity (Kabalah)\\
	\hline
	\textbf{IAO} & AOAAAIA & Greek form of ``YHVH"\\
	\hline
	\textbf{MAMMON} & ANAOAMAMAAAMA & \makecell[l]{An Arch-Daemon associated with Wealth\\also ``NAMON" (Illuminati)}\\
	
	\hline
	\hline
	\textbf{YAHWEH} & AHAEAWAHAAAYA & A popular Christianized Deity\\
	\hline
	\textbf{JESUS} & ASAUASAEAJA & God Incarnate (Christian Mysticism)\\
	\hline
	\textbf{YEHESHUA} & AUAHASAEAHAEAYA & Another form of ``JESUS"\\
	\hline
	\textbf{ALLAH} & AHAAALALAAA & The Deity (Arabic), also ``Al-Ilāh"\\
	
	\hline
	\hline
	\textbf{SATAN} & ANAAATAAASA & \makecell[l]{An Arch-Angel, the ``Devil",\\ also ``HUGUM" (Illuminati)}\\
	\hline
	\textbf{BAPHOMET} & ATAEAMAOAHAPABA & \makecell[l]{Fictitious Deity (Knights Templars)\\often confused with ``MAHOMET" (Islam)}\\
	\hline
	\textbf{ASTAROTH} & ATAHAOARAAATASA & Demonised Deity associated with Astarte\\
	
	\hline
	\hline
	\textbf{ISHTAR} & ARAAATAHASAIA & A Deity (Sumerian) also ``INANNA"\\
	\hline
	\textbf{ANU} & AUANAAA & A Deity (Sumerian) ``Father of Gods"\\
	\hline
	\textbf{MARDUK} & AKAUAVARAAAMA & A Deity (Babylon)\\
	
	\hline
	\hline
	\textbf{RAMA} & AAAMAAARA & \makecell[l]{A Deity (Hindu)\\also ``Ramachandra", ``VISHNU"}\\
	\hline
	\textbf{SHIVA} & AAAVAIAHASA & \makecell[l]{A Deity (Hindu) also ``NATARAJA"}\\
	\hline
	\textbf{KAMA} & AAAMAAAKA & Deity of Love, Eros (Hindu)\\
	\hline
	\textbf{MAHE} & AEAHAAAMA & A Deity (Hindu) also \textbf{``SHIVA"}\\

	\hline	
	\hline
	\textbf{BANGA} & AAASUANAAABA &\makecell[l]{A Deity (Ganda)\\associated with Aliens and Space}\\
	\hline
	\textbf{KIBUKA} & AAAKAUABAIAKA &\makecell[l]{A Deity (Ganda) sovereign over ``Air"}\\
	\hline
	\textbf{KINTU} & AUATAAANAIAKA &\makecell[l]{A Deity (Ganda) associated with matter,\\sovereign over ``Earth", a kind of ``Adam"}\\
	\hline
	\textbf{MANYA} & AAAYANAAAMA &\makecell[l]{A Deity (Ganda) sovereign over names\\and Knowledge}\\

	\hline	
	\hline
	\textbf{AHA} & AAAHAAA & \makecell[l]{Deity (Cwezi) of Divine Providence}\\
	\hline
	\textbf{WEIRA} & AAARAIAEAWA & \makecell[l]{Deity (Cwezi) Mysterious ``First Cause"}\\
	\hline
	\textbf{IRAKA} & AAAKAAARAIA & \makecell[l]{Deity (Cwezi)\\associated with communication}\\
	\hline
	\textbf{MANI} & AIANAAAMA & \makecell[l]{Deity (Cwezi) Mysterious ``Almighty"}\\
	
	\hline	
	\hline
	\textbf{HAZORAHIN} & ANAIAHARAOAZAHA & \makecell[l]{Deity (Illuminati) Mysterious 1}\\
	\hline
	\textbf{HANUZAMEK} & AKAEAMAZAUANAHA & \makecell[l]{Deity (Illuminati) Mysterious 1\\also ``ZHANAMUKE", ``AMENUZAHK"\\ and ``NKUZAMAHE"}\\
	\hline
	              
\end{tabular}
\caption{Examples of \textbf{Divine Names} of Power Transformed into the MYRRH language}
  \label{TABMYRRHNAMES}
\end{table}


\subsubsection{WORDS of POWER and MAGICAL FORMULAE}


Having considered \textbf{Names of POWER} in \textbf{\hyperref[TABMYRRHNAMES]{Table \ref{TABMYRRHNAMES}}}, and which names might be well applied during either \textbf{Invocations} (for God-forms) or in \textbf{Evocations} (for daemons, thoughtforms or angels), let us now turn our attention to \textbf{Words of POWER} and some \textbf{Magical Formulae}:
...
\begin{table}[H]
 ...
 \hline
	...
	\textbf{PHRASE} & \textbf{MYRRH'ed UTTERANCE} & \textbf{RELEVANCE}\\
	\hline
	\textbf{I AM THAT I AM} & \makecell[l]{AMAAA AIA\\ATAAAHATA AMAAA AIA} & \makecell[l]{Of MASONIC relevance,\\ also formula\\of God's name given\\ to MOSES at the burning bush\\ (\textbf{Exodus 3:14})\cite{newjerusalem1985}\cite{butler1952magic}}\\
	\hline

	              
\end{tabular}
\caption{Examples of \textbf{WORDS of Power} Transformed into the MYRRH language}
  \label{TABMYRRHWORDS}
\end{table}
