...
\normalsize
To manifest the arch-angel SATAN, note that the necessary sigil would be based on the SOURCE: \texttt{LEAVITHN}, and so that, the necessary expression via OZIN is as:
