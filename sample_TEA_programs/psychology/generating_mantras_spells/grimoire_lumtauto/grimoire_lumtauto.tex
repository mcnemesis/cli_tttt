...
\begin{figure}[H]
  \begin{center} % Rotate a single page of a PDF by 90 degrees
   \includegraphics[width=0.8\textwidth]{resources/crypt_of_medina}\\
...
\textit{A mini-lecture: } \url{https://youtu.be/Unra0QgLeRE}
